...
contract DoctorRegistry is Ownable {
    ...
    constructor(address _patientEMRContract, address _authorityRegistryAddress) Ownable(_authorityRegistryAddress) {
    ...
    function addDoctor(
        ...
        authorityRegistry.addAuthority(address(bytes20(bytes32(keccak256(abi.encodePacked(walletAddress))))));
    ...
    function deleteDoctor(string memory doctorNic) public onlyAuthority {
